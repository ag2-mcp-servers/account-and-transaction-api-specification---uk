...
@app.post(
    ...
    tags=['account_access_management', 'sandbox_environment_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
        APIKeyHeader(name="Client-Id"),
    ],
)
def post_account_access_consents(
    x_fapi_auth_date: Optional[str] = Header(None, alias='x-fapi-auth-date'),
    ...
    sandbox_id: str = Header(..., alias='sandbox-id'),
    body: OBReadConsent1 = None,
):
    """
...
def delete_account_access_consents__consent_id(
...
@app.get(
    ...
    tags=['account_access_management', 'account_data_retrieval'],
    security=[
        UnsuportedSecurityStub(name="None"),
        APIKeyHeader(name="Client-Id"),
    ],
)
def get_account_access_consents__consent_id(
    consent_id: str = Path(..., alias='consentId'),
    x_fapi_auth_date: Optional[str] = Header(None, alias='x-fapi-auth-date'),
    x_fapi_customer_ip_address: Optional[str] = Header(
        None, alias='x-fapi-customer-ip-address'
...
@app.get(
    ...
    tags=['account_data_retrieval', 'sandbox_environment_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
        APIKeyHeader(name="Client-Id"),
    ],
...
@app.get(
    ...
    tags=['account_data_retrieval', 'account_access_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
        APIKeyHeader(name="Client-Id"),
    ],
)
def get_accounts__account_id(
...
def get_accounts__account_id_balances(
    account_id: str = Path(..., alias='accountId'),
    x_fapi_auth_date: Optional[str] = Header(None, alias='x-fapi-auth-date'),
    x_fapi_customer_ip_address: Optional[str] = Header(
        None, alias='x-fapi-customer-ip-address'
...
@app.get(
    ...
    tags=['account_data_retrieval', 'party_data_retrieval'],
    security=[
        UnsuportedSecurityStub(name="None"),
        APIKeyHeader(name="Client-Id"),
    ],
)
def get_accounts__account_id_beneficiaries(
    account_id: str = Path(..., alias='accountId'),
    x_fapi_auth_date: Optional[str] = Header(None, alias='x-fapi-auth-date'),
    x_fapi_customer_ip_address: Optional[str] = Header(
        None, alias='x-fapi-customer-ip-address'
...
@app.get(
    ...
    tags=['party_data_retrieval', 'account_data_retrieval'],
    security=[
        UnsuportedSecurityStub(name="None"),
        APIKeyHeader(name="Client-Id"),
    ],
)
def get_accounts__account_id_parties(
    account_id: str = Path(..., alias='accountId'),
    x_fapi_auth_date: Optional[str] = Header(None, alias='x-fapi-auth-date'),
    x_fapi_customer_ip_address: Optional[str] = Header(
        None, alias='x-fapi-customer-ip-address'
...
@app.get(
    ...
    tags=['party_data_retrieval', 'account_access_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
        APIKeyHeader(name="Client-Id"),
    ],
)
def get_accounts__account_id_party(
    account_id: str = Path(..., alias='accountId'),
    x_fapi_auth_date: Optional[str] = Header(None, alias='x-fapi-auth-date'),
    x_fapi_customer_ip_address: Optional[str] = Header(
        None, alias='x-fapi-customer-ip-address'
...
def get_accounts__account_id_scheduled_payments(
    account_id: str = Path(..., alias='accountId'),
    x_fapi_auth_date: Optional[str] = Header(None, alias='x-fapi-auth-date'),
    x_fapi_customer_ip_address: Optional[str] = Header(
        None, alias='x-fapi-customer-ip-address'
...
def get_accounts__account_id_standing_orders(
    account_id: str = Path(..., alias='accountId'),
    x_fapi_auth_date: Optional[str] = Header(None, alias='x-fapi-auth-date'),
    x_fapi_customer_ip_address: Optional[str] = Header(
        None, alias='x-fapi-customer-ip-address'
...
def get_accounts__account_id_statements(
    account_id: str = Path(..., alias='accountId'),
...
def get_accounts__account_id_statements__statement_id(
    account_id: str = Path(..., alias='accountId'),
...
@app.get(
    ...
    description=""" Get Statement PDF File by Account ID and Statement ID """,
    tags=['account_data_retrieval', 'sandbox_environment_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
        APIKeyHeader(name="Client-Id"),
...
def get_accounts__account_id_statements__statement_id_file(
    account_id: str = Path(..., alias='accountId'),
    statement_id: str = Path(..., alias='statementId'),
    x_fapi_auth_date: Optional[str] = Header(None, alias='x-fapi-auth-date'),
    x_fapi_customer_ip_address: Optional[str] = Header(
...
def get_accounts__account_id_statements__statement_id_transactions(
    account_id: str = Path(..., alias='accountId'),
    statement_id: str = Path(..., alias='statementId'),
    x_fapi_auth_date: Optional[str] = Header(None, alias='x-fapi-auth-date'),
    x_fapi_customer_ip_address: Optional[str] = Header(
...
@app.post(
    ...
    tags=['sandbox_environment_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
        APIKeyHeader(name="Client-Id"),
    ],
)
def post_sandbox(body: SandboxRequest = None):
    """
    Create Sandbox
    """
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
def put_sandbox(body: Sandbox = None):
    """
    Import Sandbox
    """
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
def delete_sandbox__sandbox_id(sandbox_id: str = Path(..., alias='sandboxId')):
    """
    Delete Sandbox
    """
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
def get_sandbox__sandbox_id(sandbox_id: str = Path(..., alias='sandboxId')):
    """
    Export Sandbox
    """
    raise RuntimeError("Should be patched by MCPProxy and never executed")
